...
public class S_SCI_AdjS_Prim_SR {
	public static class Block extends Type1IBD {
		...
		public final InPort<JPulse> T25_Sec_Status_Report_Complete = new InPort<>();
		public final InPort<JPulse> T26_Prim_Status_Report_Completed = new InPort<>();
		public final OutPort<JPulse> T27_Check_Sec_Status = new OutPort<>();
		public final OutPort<JPulse> T28_Start_Prim_Status_Report = new OutPort<>();
