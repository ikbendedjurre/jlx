...
public class F_SMI_EfeS_SR {
	...
	//public static class Block extends F_EST_EfeS.Block { //(the superclass seems superfluous)
		public final static JInt Mem_t_Ini_Delay = new JInt();
		...
		public final InPort<JInt> D4_tmax_Response_MDM = new InPort<>();
		public final InPort<JInt> D5_tmax_DataTransmission = new InPort<>();
