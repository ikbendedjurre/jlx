...
public class SMI_EfeS_STD_1 extends F_SMI_EfeS_SR.Block implements StateMachine {
	...
	public class IDLE extends State {
		...
		public Incoming[] getIncoming() {
			return new Incoming[] {
				...
				new Incoming(DATA_UPDATE.class, "finalized /") //Triggered when Final0 or Final1 is reached.
			};
		}
	}
	
	public class DATA_UPDATE extends CompositeState {
		...
		public class DELAY_TIME_EXPIRING extends State {
			@Override
			public Outgoing[] getOutgoing() {
				return new Outgoing[] {
		...
		public class CHECKING_UP_TO_DATENESS extends State {
			@Override
			public Outgoing[] getOutgoing() {
				return new Outgoing[] {
					new Outgoing(Final0.class, "when(T6_Data_Up_To_Date) / T21_Data_Update_Finished := TRUE;"),
					new Outgoing(Final0.class, "after(D4_Con_tmax_Response_MDM) / T21_Data_Update_Finished := TRUE;"),
					//Mistake in diagram: D4_Con_Con_tmax_Response_MDM
		...
		public class DATA_TRANSMISSION extends CompositeState {
			...
			public class WAITING_FOR_DATA extends State {
				@Override
				public Outgoing[] getOutgoing() {
					return new Outgoing[] {
			...
			public class RECEIVING_DATA extends State {
				@Override
				public Outgoing[] getOutgoing() {
					return new Outgoing[] {
			...
			public class CHECKING_DATA extends State {
				@Override
				public Outgoing[] getOutgoing() {
					return new Outgoing[] {
		...
		public class INSTALLING_DATA extends State {
			@Override
			public Outgoing[] getOutgoing() {
				return new Outgoing[] {
	...
	public class Junction0 extends JunctionVertex {
		...
		public Incoming[] getIncoming() {
			return new Incoming[] {
				new Incoming(DATA_UPDATE.DATA_TRANSMISSION.class, "after(D5_Con_tmax_DataTransmission) / "),
				// Mistake in diagram: D5_Con_Con_tmax_DataTransmission
