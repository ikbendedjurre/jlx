 ...
 * Page 42 (extracted from a type 2 IBD)
 */
public class F_P3_SR {
	public static class Block extends Type1IBD {
		public final static PointPos Mem_last_Target_Requested = new PointPos(); //Missing in diagram!
		public final static PointPos Mem_Current_Point_Position = new PointPos(); //Missing in diagram!
		...
		public final static Initialization cOp1_Init = new Initialization(
			...
			"D6_Detection_State := \"False\";", //Set to FALSE in diagram, which is wrong type!
		...
		public final InPort<JBool> D31_Con_007400 = new InPort<>();
		...
		public final InPort<JBool> D39_Con_008700 = new InPort<>();
		public final InPort<JBool> D40_Con_008800 = new InPort<>();
		public final InPort<JBool> D41_Con_310900 = new InPort<>();
		public final OutPort<JBool> D25_Redrive = new OutPort<>();
		
		//Second column, top:
		public final OutPort<JBool> D13_Activate_PM1 = new OutPort<>();
		public final OutPort<JPulse> T12_Reset_PMs = new OutPort<>();
